...
5. **Persisted Verdicts**: The judge produces four scores from 1 to 5 plus a concise rationale. Clicking **Apply as ratings** saves the verdict onto each run's metrics.
